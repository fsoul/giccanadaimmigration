                            ...
                            <div class="carousel-item active">
                                <div class="d-block">
                                    <div class="container-fluid hs-item">
                                        ...
                                        <div class="row">
                                        <span class="col hs-content">GIC Canada Immigration оказывает широкий спектр услуг для всех,
                                            кого интересует Иммиграция в Канаду и кто желает сделать Канаду своим новым домом.
                                        </span>
                                        </div>
                                        <div class="row align-items-center justify-content-center">
                                            <a href="#" class="col-4 col-md-auto hs-item-button orange-btn">открыть
                                                иммиграционное
                                                дело</a>
                                        </div>
                                    </div>
        ...
        <div class="row justify-content-center no-gutters">
            <div class="col-sm-8 col-md-5 col-lg-4">
                <div class="container  programms-grid-item">
                    ...
                    <div class="row no-gutters">
                        <a href="#" class="col programms-gi-caption">Express Entry</a>
                    </div>
                    <div class="row no-gutters">
                    <span class="col programms-gi-text">Иммиграция в Канаду по Express Entry - это новый и быстрый способ рассмотрения
                        вашего заявления на иммиграцию в Канаду и получения постоянного место жительства (статус постоянного резидента).
                    </span>
                    </div>
                    <div class="row no-gutters align-items-end">
                        <a href="#" class="col col-auto programms-gi-link">Подробнее</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-8 col-md-5 col-lg-4">
            ...
            <div class="col">
                <div id="academy-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <div class="d-block">
                                <div class="container academy-slr-item">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 col-md-3 col-lg-3">
                                            <div class="academy-slr-item-img academy-pic2">
                                                <div class="academy-caption-wrapper">
                                                    <a href="#" class="academy-slr-item-caption white-link-none">University
                                                        of British Columbia</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-3 col-md-3 col-lg-3">
                                            <div class="academy-slr-item-img academy-pic3">
                                                <div class="academy-caption-wrapper">
                                                    <a href="#" class="academy-slr-item-caption white-link-none">University
                                                        of Alberta</a>
                                                </div>
                                        ...
                                        <div class="col-sm-3 col-md-3 col-lg-3">
                                            <div class="academy-slr-item-img academy-pic4">
                                                <div class="academy-caption-wrapper">
                                                    <a href="#" class="academy-slr-item-caption white-link-none">University
                                                        of Toronto</a>
                                                </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <a href="#" class="col col-md-auto academy-slr-item-btn orange-btn">Заполнить
                                            анкету</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <ol class="carousel-indicators hs-indicators">
                            ...
                            <li data-target="#academy-carousel" data-slide-to="3"></li>
                        </ol>
                    </div> <!--carousel-->
                </div>
            </div>
                                ...
                                <div class="container reviews-slr-item">
                                    <div class="row">
                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                            <div class="reviews-image reviews-pic1"></div>
                                        </div>
                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                            <div class="reviews-image reviews-pic2"></div>
                                        </div>
                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                            <div class="reviews-image reviews-pic3"></div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                            <h2 class="reviews-reviewer-name">Давид</h2>
                                        </div>
                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                            <h2 class="reviews-reviewer-name">Светлана</h2>
                                        </div>
                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                            <h2 class="reviews-reviewer-name">Александр</h2>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                            <p class="reviews-review">
                                                ...
                                                Команда сформировала план действий и четко ему следовала до получения
                                                иммиграционной визы.
                                            </p>
                                        </div>
                                    </div>
            ...
            <div class="container news-grid">
                <div class="row no-gutters">
                    <div class="col news-item">
                        ...
                        <div class="row no-gutters">
                            <a href="#" class="col news-gi-caption">Лучшие места для новых канадцев</a>
                        </div>
                        <div class="row no-gutters">
                    ...
                    <div class="col news-item">
                        ...
                        <div class="row no-gutters">
                            <a href="#" class="news-gi-caption">Правительство Канады повышает возраст детей при
                                иммиграции</a>
                        </div>
                        <div class="row no-gutters">
