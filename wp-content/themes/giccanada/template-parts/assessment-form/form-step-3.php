<section class="file-upload-container clearfix" id="photo-file">
    <div class="file-upload-button-container">
        ...
        <label class="ass-file-input" for="ass-studied-files" onclick="app.func.CroppieAssPhoto.croppieLoadImage();"><span>Загрузить файл</span></label>
    </div>
    <div id="added-photo"></div>
    <div style="width: 100%; height: 20px;" onclick="app.func.CroppieAssPhoto.saveCroppedBlob();">SAVE</div>
</section>