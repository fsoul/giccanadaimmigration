<section class="radio-block">
    ...
    <section>
        <input name="ass-studied-at-canada" class="ass-radio" value="no" checked type="radio"
    ...
    <section>
        <input name="ass-studied-at-canada" class="ass-radio" value="yes" type="radio" id="ass-studied-at-canada-t"
