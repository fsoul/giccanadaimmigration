<section class="radio-block">
    ...
    <section>
        <input name="ass-studied-at-canada" class="ass-radio" value="t" checked type="radio" id="ass-studied-at-canada-t" data-role="radio">
        <label for="ass-studied-at-canada-t">Да</label>
    </section>
    <section>
        <input name="ass-studied-at-canada" class="ass-radio" value="f" type="radio" id="ass-studied-at-canada-f" data-role="radio">
