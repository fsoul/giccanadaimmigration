<div>
    ...
    <div>
        <section class="radio-block">
            ...
            <section>
                <input name="part-relation" class="ass-radio" value="y" checked type="radio"
                       id="part-relation-y" data-role="radio">
                <label for="part-relation-y" >Да</label>
            </section>
            <section>
                <input name="part-relation" class="ass-radio" value="n" type="radio" id="part-relation-n" data-role="radio">
        ...
        <section class="combine-date birth-date">
            <div data-role="combine-date" data-msg="error-member-birth-date">
...
<div id="part-educ">
    ...
    <div class="multiplication-container" data-parent="family-members">
        <section>
            ...
            <input type="text" name="part-educ-name[]" id="part-educ-name-0" class="to-change-id" data-role="text">
        ...
        <section>
            ...
            <input type="text" name="part-educ-specialty[]" id="part-educ-specialty-0" class="to-change-id" data-role="text">
            <span class="error-text to-change-id" id="error-part-educ-specialty-0"></span>
        </section>
        <section>
            <label for="part-educ-country-0">Город, страна</label>
            <input type="text" name="part-educ-country[]" id="part-educ-country-0" class="to-change-id" data-role="text">
        ...
        <section>
            ...
            <select id="part-educ-level-0" name="part-educ-level[]" class="to-change-id" required data-role="select">
        ...
        <section>
            ...
            <select id="part-educ-certificate-type-0" name="part-educ-certificate-type[]" class="to-change-id" required data-role="select">
                <option value="" disabled selected>- Выбрать -</option>
        ...
        <section>
            ...
            <select id="part-educ-type-0" name="part-educ-type[]" class="to-change-id" data-role="select">
        ...
        <section>
            <div class="period-date clearfix to-change-id" id="part-educ-period-0" data-msg="error-part-educ-period-0" data-role="period-date">
                <div>
                    <div class="from-date clearfix">
                        <label>Период обучения, c</label>
                        <select title="" class="month to-change-id" name="part-educ-from-m[]" id="part-educ-from-m-0"
                                required data-class="part-educ-period-0" data-role="select">
                            <option value="" disabled selected>Month</option>
							<?= getMonthOptions(); ?>
                        </select>
                    ...
                    <div class="to-date clearfix">
                        ...
                        <select title="" id="part-educ-to-m-0" name="part-educ-to-m[]" class="month to-change-id" required
                                data-class="part-educ-period-0" data-role="select">
                            <option value="" disabled selected>Month</option>
							<?= getMonthOptions(); ?>
                        </select>
...
<div id="part-work">
    ...
    <div class="multiplication-container" data-parent="family-members">
        <section>
            ...
            <input type="text" name="part-work-name[]" id="part-work-name-0" class="to-change-id" data-role="text">
        ...
        <section>
            ...
            <input type="text" name="part-work-country[]" id="part-work-country-0" class="to-change-id" data-role="text">
            <span class="error-text to-change-id" id="error-part-work-country-0"></span>
        </section>
        <section>
            <label for="part-work-position-0">Должность</label>
            <input type="text" name="part-work-position[]" id="part-work-position-0" class="to-change-id" data-role="text">
            <span class="error-text to-change-id" id="error-part-work-position-0"></span>
        </section>
        <section>
            <div class="period-date clearfix to-change-id" id="ass-part-work-period-0" data-msg="error-ass-part-work-period-0" data-role="period-date">
                <div>
                    <div class="from-date clearfix">
                        <label>Период работы, c</label>
                        <select title="" class="month to-change-id" name="ass-part-work-from-m[]" id="ass-part-work-from-m-0"
                                required data-class="ass-part-work-period-0" data-role="select">
                            <option value="" disabled selected>Month</option>
							<?= getMonthOptions(); ?>
                        </select>
