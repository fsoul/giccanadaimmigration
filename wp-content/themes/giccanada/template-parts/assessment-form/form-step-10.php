<section>
    ...
    <select id="ass-rel-province" class="ass-province" required name="ass-rel-province" data-role="select"
...
<section>
    ...
    <select id="ass-rel-city" class="ass-city" name="ass-rel-city" required data-role="select">
