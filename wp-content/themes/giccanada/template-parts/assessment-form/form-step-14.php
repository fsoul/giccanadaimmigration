<section class="radio-block">
    ...
    <section>
        <input name="ass-worked-at-canada" class="ass-radio" value="t" checked type="radio" id="ass-worked-at-canada-t" data-role="radio">
        <label for="ass-worked-at-canada-t">Да</label>
    </section>
    <section>
        <input name="ass-worked-at-canada" class="ass-radio" value="f" type="radio" id="ass-worked-at-canada-f" data-role="radio">
...
<section class="file-upload-container clearfix" id="canadian-work-files">
    <div class="file-upload-button-container">
        <input type="file"id="ass-worked-files" multiple accept="application/pdf, image/*"
               data-container="canadian-work-files-list" data-type="multiple" data-attach="att_work" data-role="file-multiply">
...
<section class="radio-block">
    ...
    <section>
        <input name="ass-partner-worked-at-canada" class="ass-radio" value="t" checked
               type="radio" id="ass-partner-worked-at-canada-t" data-role="radio">
        <label for="ass-partner-worked-at-canada-t">Да</label>
    </section>
    <section>
        <input name="ass-partner-worked-at-canada" class="ass-radio" value="f"
               type="radio" id="ass-partner-worked-at-canada-f" data-role="radio">
