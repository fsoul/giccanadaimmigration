<section class="radio-block">
    ...
    <section>
        <input name="ass-worked-at-canada" class="ass-radio" value="no" checked type="radio" id="ass-worked-at-canada-f"
    ...
    <section>
        <input name="ass-worked-at-canada" class="ass-radio" value="yes" type="radio" id="ass-worked-at-canada-t"
               data-role="radio" required>
