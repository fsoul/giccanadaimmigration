<div id="own-work">
    ...
    <div class="multiplication-container" data-parent="work">
        <section>
            ...
            <input type="text" name="company-name[]" id="company-name-0" class="to-change-id">
        ...
        <section>
            ...
            <input type="text" name="company-country[]" id="company-country-0" class="to-change-id">
            <span class="error-text to-change-id" id="error-company-country-0"></span>
        </section>
        <section>
            <label for="company-position-0">Должность</label>
            <input type="text" name="company-position[]" id="company-position-0" class="to-change-id">
                ...
                <div>
                    <div class="from-date clearfix">
                        ...
                        <select title="" class="month to-change-id" name="ass-company-from-m[]" id="ass-company-from-m-0"
                                required data-class="ass-company-period-0">
                    ...
                    <div class="to-date clearfix">
                        ...
                        <select title="" id="ass-company-to-y-0" name="ass-company-to-y[]" class="year to-change-id"
                                required data-class="ass-company-period-0" data-type="period-date-select">
                            <option value="" disabled selected>Year</option>
                            <?= getYearOptions(); ?>
                        </select>
                    </div>
