...
<section>
	...
	<input type="text" id="ass-rel-last-name-<?=$index;?>" placeholder="Введите фамилию" data-role="text" name="relative[rel-<?=$index;?>][asa-rel-last-name]">
	<span class="error-text" id="error-ass-rel-last-name-<?=$index;?>"></span>
</section>
<section>
	<label for="ass-rel-first-name-<?=$index;?>">Имя</label>
	<input type="text" id="ass-rel-first-name-<?=$index;?>" placeholder="Введите имя" data-role="text" name="relative[rel-<?=$index;?>][ass-rel-first-name]">
...
<section>
	...
	<input type="text" id="ass-rel-status-<?=$index;?>" data-role="text" name="relative[rel-<?=$index;?>][ass-rel-status]">
