...
<section>
    ...
    <input type="text" name="part-work-name[]" id="part-work-name-<?=$index;?>" data-role="text">
    <span class="error-text" id="error-part-work-name-<?=$index;?>"></span>
</section>
<section>
    <label for="part-work-country-<?=$index;?>">Город, страна</label>
    <input type="text" name="part-work-country[]" id="part-work-country-<?=$index;?>" data-role="text">
    <span class="error-text" id="error-part-work-country-<?=$index;?>"></span>
</section>
<section>
    <label for="part-work-position-<?=$index;?>">Должность</label>
    <input type="text" name="part-work-position[]" id="part-work-position-<?=$index;?>" data-role="text">
    ...
    <div class="period-date clearfix" id="ass-part-work-period-<?=$index;?>" data-msg="error-ass-part-work-period-<?=$index;?>" data-role="period-date">
        <div>
            <div class="from-date clearfix">
                ...
                <select title="" class="month" name="ass-part-work-from-m[]" id="ass-part-work-from-m-<?=$index;?>"
                        required data-class="ass-part-work-period-<?=$index;?>" data-role="select">
                    <option value="" disabled selected>Month</option>
					<?= getMonthOptions(); ?>
                </select>

                <select title="" class="year" name="ass-part-work-from-y[]" id="ass-part-work-from-y-<?=$index;?>"
                        required data-class="ass-part-work-period-<?=$index;?>" data-role="select">
            ...
            <div class="to-date clearfix">
                <label>по</label>
                <select title="" id="ass-part-work-to-m-<?=$index;?>" name="ass-part-work-to-m[]" class="month"
                        required data-class="ass-part-work-period-<?=$index;?>" data-role="select">
                    <option value="" disabled selected>Month</option>
					<?= getMonthOptions(); ?>
                </select>

                <select title="" id="ass-part-work-to-y-<?=$index;?>" name="ass-part-work-to-y[]" class="year"
                        required data-class="ass-part-work-period-<?=$index;?>" data-role="select">
                    <option value="" disabled selected>Year</option>
					<?= getYearOptions(); ?>
                </select>
...
<section>
    ...
    <textarea name="part-work-requirement[]" id="part-work-requirement-<?=$index;?>" rows="4"
