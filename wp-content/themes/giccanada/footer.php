<div class="container-fluid footer"><!--footer-->
                ...
                <div class="col-6">
                    <div class="row no-gutters flex-nowrap justify-content-center">
                        ...
                        <div class="col-5 col-auto footer-item">
                            ...
                            <div class="row no-gutters footer-contact-item">
                                <a href="#" class="col-auto footer-phone"></a>
                                <a href="#" class="col-auto footer-contact-link footer-text white-link-none">054-3319797</a>
                            </div>
                            <div class="row no-gutters footer-contact-item">
    ...
    <div class="container">
        <div class="row align-items-center no-gutters footer-bottom flex-nowrap">
            <div class="col-3">
                <!--footer-socials-->
            ...
            <div class="col-6">
                <div class="row no-gutters flex-nowrap justify-content-center">
                    <a href="#" class="col-5 footer-text footer-site-map white-link-underline">Карта сайта</a>
                    <div class="col-5"></div>
                </div>
            </div>
